    	...
    	**************************************************************************** */
		...
		else
		{
			try
			{
				...
				//hide the form
				$showform=0;
				echo "<div class='success'><p>Thank you for becomming a member! Welcome to the new millennium!</p></div>";
			}//try
			catch(PDOException $e)
			{
				echo "<div class='error'><p></p>Ummmm.....well this is embarassing! Something went wrong...." .$e->getMessage() . "</p></div>";
				exit();
			}
		}//else errors
	}//isset submit
