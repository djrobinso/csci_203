...
if(isset ($_POST['submit']))
{
    ...
    else
    {
        ...
        try
        {
            $sqllogin = "SELECT * FROM djrobinso_users WHERE uname = :uname";
            ...
            else
            {
                ...
                {
                    echo "<p class='errors'>The uname and password combination you entered is not correct.  Please try again.</p>";
                }
                else
                {
...
if($showform ==1)
{
    ...
    <p id="loginMessage">Please login in to see the more restricted areas.</p>
